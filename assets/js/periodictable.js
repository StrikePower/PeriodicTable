let alkali = document.querySelectorAll(".alkali");
let alkaline = document.querySelectorAll(".alkaline");
let lanthanides = document.querySelectorAll(".lanthanides");
let actinides = document.querySelectorAll(".actinides");
let transitionmetals = document.querySelectorAll(".transitionmetals");
let noblegases = document.querySelectorAll(".noblegases");
let othernonmetals = document.querySelectorAll(".othernonmetals");
let posttransitionmetals = document.querySelectorAll(".posttransitionmetals");
let metalloids = document.querySelectorAll(".metalloids");
...
let elementLibrary = {//alkali
Li3: ["Lithium is the lightest metal.", "Lithium has the lowest density of any metal.", "Lithium burns with a bright red color."],
Na11: ["Sodium is a soft, malleable and shiny solid at room temperature.", "Sodium is less dense than water.", "Sodium is soft enough to cut with a butter knife at room temperature."],
K19: ["Potassium is a shiny, lustrous metal at room temperature.", "Potassium vigorously reacts with water to form hydrogen gas.", "Potassium was the first metal to be discovered by electrolysis."],
Rb37: ["Rubidium melts just a little above body temperature.", "Rubidium was discovered using spectroscopy.", "Rubidium is the second most electropositive element."],
Cs55: ["Caesium was discovered by Robert Bunsen and Gustav Kirchhoff in 1860.", "Caesium, which is Latin for 'sky blue,' comes from the blue emission lines it gives off in spectroscopy.", "It was the first element ever to be discovered using the newly created spectroscope."],
Fr87: ["Francium is the second rarest element in the Earth's crust next to astatine.", "Francium is a heavy, unstable, radioactive metal with a maximum life of only 22 minute.", "Francium decays after 22 minutes and turn into astatine, radon, or radium."],
Be4: ["Beryllium is a silvery-white metal.", "Mixing beryllium with these metals increases their electrical and thermal conductivity.", "Beryllium is used in alloys with copper or nickel to make gyroscopes, springs, electrical contacts, spot-welding electrodes and non-sparking tools."],
//alkaline
Mg12: ["", "", ""],
Ca20: ["", "", ""],
Sr38: ["", "", ""],
...
// 	let key = alkali[i].textContent
// 	alkali[i].addEventListener('click', function(){
// 	alert(elementLibrary[key][Math.floor(Math.random()*3)]);
// })
// }

// for(let i=0; i<alkaline.length; i++){
// 	let key = alkaline[i].textContent
// 	alkaline[i].addEventListener('click', function(){
// 	alert(elementLibrary[key][Math.floor(Math.random()*3)]);
// })
// }
...
function clearHighlight(){for(let i=0; i<element.length; i++){ 
	element[i].classList.remove("highlight")}}

for(let i=0; i<element.length; i++){ 
	element[i].addEventListener('click', function(){
	let selectedElement = (elementsDatabase.find(a => a.symbol + a.number === element[i].textContent))	
	alert(`Element: ${selectedElement.name}
Symbol: ${selectedElement.symbol}
Appearance: ${selectedElement.appearance}
...
let inputValueCS = inputValue.charAt(0).toUpperCase() + inputValue.slice(1)
console.log(inputValueCS)
let selectedElement =  (elementsDatabase.find(a => a.name  === inputValueCS || a.symbol === inputValueCS));
console.log(selectedElement.number)
for(let i=0; i<element.length; i++){
element[i].classList.remove("highlight")
}
elementbtn = document.getElementById(selectedElement.number)
...
function alkalisHighlight(){for(let i=0; i<alkali.length; i++){
alkali[i].classList.toggle("highlight")	
}}
function alkalisUnHighlight(){for(let i=0; i<alkali.length; i++){
alkali[i].classList.remove("highlight")	
}}
function alkalinesHighlight(){for(let i=0; i<alkaline.length; i++){
alkaline[i].classList.toggle("highlight")	
}}
function alkalinesUnHighlight(){for(let i=0; i<alkaline.length; i++){
alkaline[i].classList.remove("highlight")	
}}
function lanthanidesHighlight(){for(let i=0; i<lanthanides.length; i++){
lanthanides[i].classList.toggle("highlight")	
}}
function lanthanidesUnHighlight(){for(let i=0; i<lanthanides.length; i++){
lanthanides[i].classList.remove("highlight")	
}}
function actinidesHighlight(){for(let i=0; i<actinides.length; i++){
actinides[i].classList.toggle("highlight")	
}}
function actinidesUnHighlight(){for(let i=0; i<actinides.length; i++){
actinides[i].classList.remove("highlight")	
}}
function transitionmetalsHighlight(){for(let i=0; i<transitionmetals.length; i++){
transitionmetals[i].classList.toggle("highlight")	
}}
function transitionmetalsUnHighlight(){for(let i=0; i<transitionmetals.length; i++){
transitionmetals[i].classList.remove("highlight")	
}}
function noblegasesHighlight(){for(let i=0; i<noblegases.length; i++){
noblegases[i].classList.toggle("highlight")	
}}
function noblegasesUnHighlight(){for(let i=0; i<noblegases.length; i++){
noblegases[i].classList.remove("highlight")	
}}
function othernonmetalsHighlight(){for(let i=0; i<othernonmetals.length; i++){
othernonmetals[i].classList.toggle("highlight")	
}}
function othernonmetalsUnHighlight(){for(let i=0; i<othernonmetals.length; i++){
othernonmetals[i].classList.remove("highlight")	
}}
function posttransitionmetalsHighlight(){for(let i=0; i<posttransitionmetals.length; i++){
posttransitionmetals[i].classList.toggle("highlight")	
}}
function posttransitionmetalsUnHighlight(){for(let i=0; i<posttransitionmetals.length; i++){
posttransitionmetals[i].classList.remove("highlight")	
}}
function metalloidsHighlight(){for(let i=0; i<metalloids.length; i++){
metalloids[i].classList.toggle("highlight")	
}}
function metalloidsUnHighlight(){for(let i=0; i<metalloids.length; i++){
metalloids[i].classList.remove("highlight")	
}}
function halogensHighlight(){for(let i=0; i<halogens.length; i++){
halogens[i].classList.toggle("highlight")	
}}
function halogensUnHighlight(){for(let i=0; i<halogens.length; i++){
halogens[i].classList.remove("highlight")	
}}
function unknownHighlight(){for(let i=0; i<unknown.length; i++){
unknown[i].classList.toggle("highlight")	
}}
function unknownUnHighlight(){for(let i=0; i<unknown.length; i++){
unknown[i].classList.remove("highlight")	
}}

let alkalibutton = document.querySelector(".alkalibutton");
alkalibutton.addEventListener('click', function(){
let buttons = document.querySelectorAll("button")
for(let i=0; i<buttons.length; i++){
	if(buttons[i] != alkalibutton){
	buttons[i].classList.remove("buttonhighlight")}
}
alkalibutton.classList.toggle("buttonhighlight")
alkalisHighlight()
alkalinesUnHighlight()
lanthanidesUnHighlight()
actinidesUnHighlight()
transitionmetalsUnHighlight()
noblegasesUnHighlight()
othernonmetalsUnHighlight()
posttransitionmetalsUnHighlight()
metalloidsUnHighlight()
halogensUnHighlight()
unknownUnHighlight()
})

let alkalinebutton = document.querySelector(".alkalinebutton");
alkalinebutton.addEventListener('click', function(){
let buttons = document.querySelectorAll("button")
for(let i=0; i<buttons.length; i++){
	if(buttons[i] != alkalinebutton){
	buttons[i].classList.remove("buttonhighlight")}
}
alkalinebutton.classList.toggle("buttonhighlight")
alkalisUnHighlight()
alkalinesHighlight()
lanthanidesUnHighlight()
actinidesUnHighlight()
...
let lanthanidebutton = document.querySelector(".lanthanidebutton");
lanthanidebutton.addEventListener('click', function(){
let buttons = document.querySelectorAll("button")
for(let i=0; i<buttons.length; i++){
	if(buttons[i] != lanthanidebutton){
		buttons[i].classList.remove("buttonhighlight")}
}	

lanthanidebutton.classList.toggle("buttonhighlight")
alkalisUnHighlight()
alkalinesUnHighlight()
lanthanidesHighlight()
actinidesUnHighlight()
transitionmetalsUnHighlight()
noblegasesUnHighlight()
othernonmetalsUnHighlight()
...
let actinidebutton = document.querySelector(".actinidebutton");
actinidebutton.addEventListener('click', function(){
let buttons = document.querySelectorAll("button")
for(let i=0; i<buttons.length; i++){
	if(buttons[i] != actinidebutton){
	buttons[i].classList.remove("buttonhighlight")}
}
actinidebutton.classList.toggle("buttonhighlight")
alkalisUnHighlight()
alkalinesUnHighlight()
lanthanidesUnHighlight()
actinidesHighlight()
...
let transitionmetalsbutton = document.querySelector(".transitionmetalsbutton");
transitionmetalsbutton.addEventListener('click', function(){
let buttons = document.querySelectorAll("button")
for(let i=0; i<buttons.length; i++){
	if(buttons[i] != transitionmetalsbutton){
	buttons[i].classList.remove("buttonhighlight")}
}
transitionmetalsbutton.classList.toggle("buttonhighlight")
alkalisUnHighlight()
alkalinesUnHighlight()
lanthanidesUnHighlight()
actinidesUnHighlight()
transitionmetalsHighlight()
noblegasesUnHighlight()
othernonmetalsUnHighlight()
posttransitionmetalsUnHighlight()
metalloidsUnHighlight()
...
let noblegasbutton = document.querySelector(".noblegasbutton");
noblegasbutton.addEventListener('click', function(){
let buttons = document.querySelectorAll("button")
for(let i=0; i<buttons.length; i++){
	if(buttons[i] != noblegasbutton){
	buttons[i].classList.remove("buttonhighlight")}
}
noblegasbutton.classList.toggle("buttonhighlight")
alkalisUnHighlight()
alkalinesUnHighlight()
lanthanidesUnHighlight()
actinidesUnHighlight()
...
let othernonmetalsbutton = document.querySelector(".othernonmetalsbutton");
othernonmetalsbutton.addEventListener('click', function(){
let buttons = document.querySelectorAll("button")
for(let i=0; i<buttons.length; i++){
	if(buttons[i] !=othernonmetalsbutton){
	buttons[i].classList.remove("buttonhighlight")}
}
othernonmetalsbutton.classList.toggle("buttonhighlight")
alkalisUnHighlight()
alkalinesUnHighlight()
lanthanidesUnHighlight()
actinidesUnHighlight()
transitionmetalsUnHighlight()
noblegasesUnHighlight()
othernonmetalsHighlight()
posttransitionmetalsUnHighlight()
metalloidsUnHighlight()
halogensUnHighlight()
unknownUnHighlight()})

let posttransitionmetalsbutton = document.querySelector(".posttransitionmetalsbutton");
posttransitionmetalsbutton.addEventListener('click', function(){
let buttons = document.querySelectorAll("button")
for(let i=0; i<buttons.length; i++){
	if(buttons[i] != posttransitionmetalsbutton){
		buttons[i].classList.remove("buttonhighlight")
	}
}
posttransitionmetalsbutton.classList.toggle("buttonhighlight")
alkalisUnHighlight()
alkalinesUnHighlight()
lanthanidesUnHighlight()
actinidesUnHighlight()
...
noblegasesUnHighlight()
othernonmetalsUnHighlight()
posttransitionmetalsHighlight()
metalloidsUnHighlight()
halogensUnHighlight()
unknownUnHighlight()})

let metalloidsbutton = document.querySelector(".metalloidsbutton");
metalloidsbutton.addEventListener('click', function(){
let buttons = document.querySelectorAll("button")
for(let i=0; i<buttons.length; i++){
	if(buttons[i] != metalloidsbutton){
	buttons[i].classList.remove("buttonhighlight")}
}
metalloidsbutton.classList.toggle("buttonhighlight")
alkalisUnHighlight()
alkalinesUnHighlight()
lanthanidesUnHighlight()
actinidesUnHighlight()
...
let halogenbutton = document.querySelector(".halogenbutton");
halogenbutton.addEventListener('click', function(){
let buttons = document.querySelectorAll("button")
for(let i=0; i<buttons.length; i++){
	if(buttons[i] != halogenbutton){
	buttons[i].classList.remove("buttonhighlight")}
}
halogenbutton.classList.toggle("buttonhighlight")
alkalisUnHighlight()
alkalinesUnHighlight()
lanthanidesUnHighlight()
actinidesUnHighlight()
...
let unknownbutton = document.querySelector(".unknownbutton");
unknownbutton.addEventListener('click', function(){
let buttons = document.querySelectorAll("button")
for(let i=0; i<buttons.length; i++){
	if(buttons[i] != unknownbutton){
	buttons[i].classList.remove("buttonhighlight")}
}
unknownbutton.classList.toggle("buttonhighlight")
alkalisUnHighlight()
alkalinesUnHighlight()
lanthanidesUnHighlight()
actinidesUnHighlight()
...
clearbutton.classList.add("buttonhighlight")
clearbutton.classList.toggle("buttonhighlight")
alkalisUnHighlight()
alkalinesUnHighlight()
lanthanidesUnHighlight()
actinidesUnHighlight()
